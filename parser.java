	...
	public static void main(String[] args) throws IOException{
		...
		*/
		...
		while(!remainingInput.isEmpty()){
			...
			if(!remainingInput.isEmpty()&&!terminal.contains(remainingInput.get(0))){
			...
			for(int k=0;k<nonterminal.size();k++){
				for(int j=0; j< terminal.size();j++){
					if(!remainingInput.isEmpty()&&remainingInput.get(0).equals(terminal.get(j))&&parserStack.get(0).equals(nonterminal.get(k))){
						if(table[k][j]==0){
							System.out.println("Error");
							//System.exit(0);
							//continue;
			...
			if(!remainingInput.isEmpty()&&!nonterminal.contains(parserStack.get(0))&&!remainingInput.get(0).equals(parserStack.get(0))){
				System.out.println(" Error");
				//System.exit(0);									
				//continue;
				break;
